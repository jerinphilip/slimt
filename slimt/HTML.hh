...
class HTML {
 ...
 private:
  ...
  AnnotatedText restoreSource(AnnotatedText const &in,
  ...
  /// `response.target`.
  AnnotatedText restoreTarget(
      AnnotatedText const &in,
  ...
  void copyTagStack(Response const &response,
  ...
  void annotateTagStack(Response const &response,
                        std::vector<SpanIterator> const &targetTokenSpans,
  ...
  /// possible.
  void hardAlignments(Response const &response,
